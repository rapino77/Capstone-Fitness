 ...
 * 
 * This module provides intelligent exercise rotation and periodization logic
 * to prevent plateaus, reduce injury risk, and optimize training progression.
 * 
 * Supported periodization models:
...
export function calculateRotationScore(exercise, workoutHistory) {
...
export function generateRotationSuggestions(currentExercise, workoutHistory, options = {}) {
  const {
    maxSuggestions = 3,
...
export function determineCurrentPhase(workoutHistory, startDate = null) {
  if (!workoutHistory || workoutHistory.length === 0) {
    return {
      phase: 'HYPERTROPHY',
      weekInPhase: 1,
...
export function generatePeriodizedWorkout(exercise, currentPhase, lastWorkout = null) {
