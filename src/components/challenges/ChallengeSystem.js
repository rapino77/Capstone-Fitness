            ...
            {completedChallenges.slice(-6).map((challenge) => (
              <div key={challenge.id} className="bg-gradient-to-br from-green-100 to-green-200 rounded-lg p-4 border border-green-300">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <div>
                    <h4 className="font-medium" style={{ color: '#1f2937' }}>{challenge.name}</h4>
                    <p className="text-xs" style={{ color: '#4b5563' }}>{challenge.category}</p>
                  </div>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="font-medium" style={{ color: '#374151' }}>{challenge.reward}</span>
